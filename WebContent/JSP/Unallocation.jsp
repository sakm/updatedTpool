...
<form  class="box" id="box" action="AdminUtilities">
...
Map<String,Trainer> map=srv.getAllRecords();
...

{
	Trainer t = map.get(i);
			...
			List<Skill> skillList=(List<Skill>)srv.getSkillsByTId(t.getTrainerId());
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="UpdateAllocation" value="<%= t.getTrainerId()+"&"+i.split(" ")[0] %>" style="display: flex" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<td><input type="submit" name="AdminAction" value="UnallocateTrainers" style="display: flex" >
